...
urlpatterns = [
    ...
    url(r'^(?P<question_id>\d+)/results/(?P<selected_choice_id>\d+)$', app.views.results, name='results'),
    ...
    url(r'^VerPreguntas/', app.views.VerPreguntas, name='VerPreguntas'),
    url(r'^VerPreguntasTema/', app.views.VerPreguntasTema, name='VerPreguntasTema'),
]